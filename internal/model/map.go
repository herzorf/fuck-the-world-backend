...
type Map struct {
	...
	Info      string    `json:"info" gorm:"type:text;nut null;comment:地图描述"`
	Remark    string    `json:"remark" gorm:"type:varchar(255);nut null;comment:备注"`
	IsActive  bool      `json:"isActive" gorm:"default:true;nut null;comment:是否启用"`
